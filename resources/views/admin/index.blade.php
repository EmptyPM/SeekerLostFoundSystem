...
.card-body-icon:hover {
	...
	transform: scale(1.5);
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-fw fa-list"></i> All Items
					</div>
					<div class="card-body">
							...
							<table class="table table-bordered table-sm" id="dataTable"
								...
								<tbody>
									<tr>
										...
										<td><button class="btn btn-secondary btn-sm " data-toggle="modal" data-target="#exampleModalCenter">View</button>
										<button type="button" class="btn btn-primary btn-sm"><a href="{{url('/admin/item/item_edit')}}" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i> Edit</a></button></td>
									</tr>
									<tr>
										<td>02</td>
										<td>2011/07/25</td>
									...
									<tr>
										...
										<td><button class="btn btn-secondary btn-sm " data-toggle="modal" data-target="#exampleModalCenter">View</button> <button type="button" class="btn btn-primary btn-sm"><a href="{{url('/admin/item/item_edit')}}" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i> Edit</a></button></td>
									</tr>
									<tr>
										<td>04</td>
										<td>2012/03/29</td>

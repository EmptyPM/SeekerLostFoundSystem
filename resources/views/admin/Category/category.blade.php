                                ...
                                <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Description....</td>
                                            <td><button type="button" class="btn btn-primary btn-sm"><a href="category_edit.html" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i>Edit</a></button>
                        ...
                        <div class="col-xl-4 col-sm-6 mb-4">
                            <div class="card mb-3">
                                ...
                                <form action="" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                            ...
                                            <input type="text" class="form-control" id="fname" placeholder="Category Id" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail4">Name</label>
                                            <input type="text" class="form-control" id="fname" placeholder="Category Name" required>
                                        </div>
                                        <div class="form-group">

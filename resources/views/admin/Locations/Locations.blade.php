                    ...
                    <div class="row">
                                ...
                                <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-primary btn-sm"><a href="Locations_edit.html" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i>Edit</a></button>
                        ...
                        <div class="col-xl-4 col-sm-6 mb-4">
                            <div class="card mb-3">
                                ...
                                <form action="../location_add_action" method="post" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                    
                                   
                                   		<div class="form-group">
                                            <label for="inputEmail4">Location ID</label>
                                            <input type="text" class="form-control" id="fname" placeholder="Location Id" required name="locatinID">
                                        </div>
                                   		 
                                        <div class="form-group">
                                            <label for="inputEmail4">Name</label>
                                            <input type="text" class="form-control" id="fname" placeholder="Locations Name" required name="location">
                                        </div>
                                        <div class="form-group ">

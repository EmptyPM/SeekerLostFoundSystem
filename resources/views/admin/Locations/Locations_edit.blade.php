                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                         ...
                         <li class="breadcrumb-item active"><a href="Locations.html" style="text-decoration: none;">Locations</a></li>
                            ...
                            <div class="card mb-3">
                                ...
                                <form action="" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                    ...
                                    <div class="form-group">
                                            <label for="inputLocationID">Location ID</label>
                                            <input type="text" class="form-control" id="LID" placeholder="Location Id" required readonly>
                                        </div>
                                   <div class="form-group">

	...
	transform: scale(1.5);
                                ...
                                <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Description....</td>
                                            <td><button type="button" class="btn btn-primary btn-sm"><a href="StorageLocations_edit.html" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i>Edit</a></button>
				...
				<div class="col-xl-4 col-sm-6 mb-4">
					<div class="card mb-3">
						...
						<form action="../storage_add_action" method="post"
							style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
							
							<div class="form-group">
                                            <label for="inputEmail4">Storage ID</label>
                                            <input type="text" class="form-control" id="storage_id" placeholder="Storage ID" name="storage_id" required>
                                        </div>
							
							<div class="form-group">
								<label for="inputEmail4">Storage Name</label>
								 <input type="text"
							...
							<div class="form-group">
								...
								<textarea class="form-control" rows="5" id="description"
									required  name="description">Description.</textarea>
							</div>

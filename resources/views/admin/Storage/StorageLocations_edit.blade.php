                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                         ...
                         <li class="breadcrumb-item active"><a href="StrorageLocation.html" style="text-decoration: none;">Storage</a></li>
                            ...
                            <div class="card mb-3">
                                ...
                                <form action="" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                    ...
                                    <div class="form-group">
                                            <label for="inputStorageID">Location ID</label>
                                            <input type="text" class="form-control" id="Storage" placeholder="Storage Id" required readonly>
                                        </div>
                                   <div class="form-group">

<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="{{url('/')}}">Lost & Found System</a>
		...
		<ul class="navbar-nav ml-auto ml-md-0">
			...
			<li class="nav-item dropdown no-arrow mx-1"><a
				class="nav-link " href="{{url('/admin/searchpage')}}" 
				role="button"  aria-haspopup="true"
				aria-expanded="false"> <i class="fas fa-search fa-lg"></i>
			</a>
				</li>
				<li class="nav-item dropdown no-arrow mx-1"><a
				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					<a style="color: green;" class="dropdown-item" href="{{url('/admin/item/add_item')}}">
			...
			<li class="nav-item dropdown no-arrow"><a
				...
				<div class="dropdown-menu dropdown-menu-right"
					...
					<a class="dropdown-item" href="{{url('/admin/user/user_profile')}}"> <i
